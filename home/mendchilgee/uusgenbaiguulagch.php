...
<html xmlns:og="http://ogp.me/ns#" xmlns:fb="http://www.facebook.com/2008/fbml">
    <head>
        <title>Үүсгэн байгуулагчийн мэндчилгээ</title>
    	<meta charset="utf-8">
 ...
 <link href="/home/mendchilgee/tugsugch-main.css" rel="stylesheet">
	...
	<div class="sub_header" id="sub_header">
    	<div class="container">
        	<div class="row">
            <div class="col-md-4">
                <h3>Үүсгэн байгуулагчийн мэндчилгээ</h3>
            </div>
    ...
    <div class="container">
    	<div class="page_out">
            <p><img src="/home/mendchilgee/image/<?php echo $photo?>" alt="" style="line-height: 1.6em; width: 274px; height: 412.432055749129px; float: left; margin: 0px 10px 15px 0px">
            <?php echo $body;?>
        </div>
    </div>
</div>
