  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
        ...
        <tr>
           <td><?php echo $row['ovog'];?></td>
            <td><?php echo $row['ner'];?></td>
      
      <td><img src="/home/teacher/image/<?php echo $row['photo'];?>" alt="" style="width:50px;height:50px"></td>
      
      <td><?php echo $row['huis'];?></td>
      
      <td><?php echo $row['ovog1'];?></td>
            <td><?php echo $row['ner1'];?></td>
      <td><?php echo $row['id'];?></td>
      <td><a href="upload-teacher.php?id=<?php echo $row['id'];?>">Засах</a></td>
            <td><a href="process.php?action=teacherdel&id=<?php echo $row['id'];?>">Устгах</a></td>
...
<div class="teacher-b">
<button class="btn-normal"> <a href="upload-teacher.php">Багш шинээр бүртгэх</a></button>
