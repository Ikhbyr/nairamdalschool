<?php
	...
	$qry = "select id, photo, title,type,body,date from amjilt where type='bagsh' order by date desc";
...
<header>
  <h2>Багшийн амжилт</h2>
</header>

<?php while($row = $result->fetch_assoc()){?>
 <div class="well"><a href="/home/amjilt/Neg_bagshiin_amjilt.php?id=<?php echo $row['id'];?>">
                <div class="row">
